...
export default function WorkoutPlayer({ workoutData, onClose }) {
  ...
  function handleManualContinue() {
    ...
    if (phase === "intro") {
      ...
      // Uždaryk modalą, kai paspaudžia užbaigimą per summary
      onClose();
    }
  }
  ...
  function handlePhaseComplete() {
    ...
    // Viskas baigta – PEREIK Į SUMMARY
    else {
      setPhase("summary");
    }
  }
  ...
  // PABAIGOS LANGAS, kaip motyvacinis, tik su summary info
  if (phase === "summary") {
    return (
      <div className="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center z-50">
        <div className="bg-white p-6 rounded-lg max-w-lg text-center">
          ...
          {/* Gali įdėti čia apibendrinimą, statistiką, ką tik nori */}
          <button
